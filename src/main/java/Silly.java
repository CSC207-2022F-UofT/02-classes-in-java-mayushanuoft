...
public class Silly implements Comparable<Silly>{
    ...
    // The method above is a constructor that operates within the Silly class. It takes two inputs of
    //      string and concatenates them into one, which will be the name instance of this method.
